...
<body>
    <header>
        ...
        <main>
            ...
            <section class="flex flex-wrap items-center -mx-3 font-sans px-4 mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20 pt-20">
                <!-- Column-1 -->
                <div class="px-3 w-full lg:w-2/5">
                    <div
                        ...
                        <h2 class="mb-4 text-3xl font-bold text-left lg:text-5xl">
                            ...
                            <span class="text-5xl text-blue-500 leading-relaxeds">TimeToRecall</span>
                        </h2>
                    ...
                    <div class="text-center lg:text-left">
                        <a class="block visible py-4 px-8 mb-4 text-xs font-semibold tracking-wide leading-none text-white bg-blue-500 rounded cursor-pointer sm:mr-3 sm:mb-0 sm:inline-block">Reminder</a>
                        <a class="block visible py-4 px-8 text-xs font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-slate-500">En savoir +</a>
                    </div>
                </div>
                <!-- Column-2 -->
